<?php
/**
 * 2014-2019 Alliance bank
 *
 *  @author DM
 *  @copyright  2014-2019 Alliance bank
...
class fondy_banking extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('Alliance bank wire payments');
        ...
        $this->_html .=
			...
			<legend><img src="../img/admin/contact.gif" />' . $this->l('Contact details') . '</legend>
				<table border="0" width="500" cellpadding="0" cellspacing="0" id="form">
					<tr><td colspan="2">' . $this->l('Please specify the Alliance bank account details for customers') . '.<br /><br /></td></tr>
    ...
    private function _displayFondy()
    {
        $this->_html .= '<img src="../modules/fondy_banking/views/img/logo.png" style="float:left; margin-right:15px;"><b>' .
            $this->l('This module allows you to accept payments by Alliance bank.') . '</b><br /><br />' .
    ...
    public function hookPayment($params)
    {
        ...
        $data = array(
            ...
            'this_description_pl' => $this->l('Alliance bank PL banklinks.'),
