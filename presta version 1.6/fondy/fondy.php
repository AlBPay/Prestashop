...
class Fondy extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('Alliance bankonline payments');
        $this->description = $this->l('Payments via Alliance bank');
    ...
    protected function getConfigForm()
    {
        ...
        return array(
            'form' => array(
                'legend' => array(
                    'title' => $this->l('Please specify the Alliance bankaccount details for customers'),
                    'icon' => 'icon-cogs',
                ),
                'input' => array(
                    array(
    ...
    public function hookPayment($params)
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'this_description' => $this->l('Pay via Alliance bank')
        ));
